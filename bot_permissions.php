...
<div class="container theme-showcase" role="main">
	...
	<div class="jumbotron">
		...
		<p><font size="4">This page show the permissions MarksBot requires to run commands and what permissions you need</font></p>

	<?php include("./assets/includes/requiredPermissions.inc")?>
